...
const Navbar = () => {
  ...
  return (
    <>
      {/* Floating Logo - Positioned absolutely over navbar */}
      ...
      {/* Navbar - EXACTLY as original, no height changes */}
      <nav
        ref={navbarRef}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="lg:hidden flex items-center">
              ...
              >
                ...
                <div className={`w-6 h-0.5 bg-white transition-all duration-300 ${isOpen ? 'rotate-45 translate-y-1.5' : '-translate-y-1'
                  }`}></div>
                <div className={`w-6 h-0.5 bg-white transition-all duration-300 mt-1 ${isOpen ? 'opacity-0' : 'opacity-100'
                  }`}></div>
                <div className={`w-6 h-0.5 bg-white transition-all duration-300 mt-1 ${isOpen ? '-rotate-45 -translate-y-1.5' : 'translate-y-1'
                  }`}></div>
