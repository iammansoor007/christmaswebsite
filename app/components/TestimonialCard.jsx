...
const getColorForIndex = (index) => {
  const colorArray = [BRAND_COLORS.red, BRAND_COLORS.amber, BRAND_COLORS.emerald];
...
const Testimonials = () => {
  ...
  const testimonials = STATIC_TESTIMONIALS.map((item, index) => ({
    ...item,
  ...
  const renderStars = (rating = 5, isActive = false, color = BRAND_COLORS.amber) => {
    if (!isActive) {
      return (
      ...
      <div className="container mx-auto px-4 relative max-w-7xl">
        ...
        <div className="text-center mb-6 lg:mb-8">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            ...
            <span 
              className="block mt-2 bg-gradient-to-r from-red-600 via-amber-500 to-emerald-600 bg-clip-text text-transparent"
            >
              Clients Say
            </span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover why homeowners and businesses trust us to transform their spaces into magical holiday experiences.
          </p>
                          ...
                          <div className="flex flex-col h-full pt-12">
                            ...
                            <div className="flex flex-col items-center mb-6">
                              <div className="mb-2" style={{ height: '30px' }}>
                                {renderStars(testimonial.rating, isActive, testimonial.color)}
                              </div>
                            </div>
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div 
                                    ...
                                    style={{ color: isActive ? testimonial.color : BRAND_COLORS.dark }}
                                  >
                                    {testimonial.author}
                                  </div>
        ...
        <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex items-center gap-3 mx-4">
              {testimonials.map((testimonial, index) => {
                ...
                const isAdjacent = Math.abs(index - current) === 1 || 
                                  Math.abs(index - current) === testimonials.length - 1;
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm text-gray-500">
              <span className="font-semibold" style={{ color: currentTestimonial.color }}>
                {current + 1}
              </span>
            ...
            <div className="flex items-center gap-2">
              <div className={`w-2 h-2 rounded-full ${isAutoRotating ? 'animate-pulse' : ''}`}
                style={{ backgroundColor: isAutoRotating ? currentTestimonial.color : BRAND_COLORS.gray }}
              />
            </div>
          </div>
        </div>
